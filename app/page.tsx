    ...
    <main className="flex min-h-screen flex-col justify-between p-12">
      ...
      <div className='main-course left'>
        <div className='content'>
          ...
          <div className='description'> Lorem ipsum dolor sit amet consectetur adipisicing elit. Ea quae praesentium hic accusamus doloribus at, iste quaerat quod ratione numquam illum accusantium, tempora sunt nesciunt cupiditate, voluptas cum harum adipisci!</div>
